...
@_ZZN4llvm4castINS_11InstructionEPNS_5ValueEEENS_10cast_rettyIT_T0_E8ret_typeERKS6_E8__func__ = internal constant [5 x i8] c"cast\00", align 8 
@.str = private constant [31 x i8] c"include/llvm/Support/Casting.h\00", align 8 
@.str1 = private constant [59 x i8] c"isa<X>(Val) && \22cast<Ty>() argument of incompatible type!\22\00", align 8 


define zeroext i8 @_Z3fooPN4llvm5ValueE(%"struct.llvm::Value"* %V) ssp {
entry:
  %0 = getelementptr inbounds %"struct.llvm::Value", %"struct.llvm::Value"* %V, i64 0, i32 1 
  %1 = load i8, i8* %0, align 8                       
  %2 = icmp ugt i8 %1, 20                         
  br i1 %2, label %bb.i, label %bb2

bb.i:                                             
  %toBoolnot.i.i = icmp ult i8 %1, 21             
...
_ZN4llvm8dyn_castINS_11InstructionEPNS_5ValueEEENS_10cast_rettyIT_T0_E8ret_typeERKS6_.exit: 

  %3 = icmp eq %"struct.llvm::Value"* %V, null    
