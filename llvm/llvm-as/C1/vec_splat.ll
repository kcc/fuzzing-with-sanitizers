...
define void @splat_imm_i32(%i4* %P, %i4* %Q, i32 %X) nounwind {
        %q = load %i4, %i4* %Q               
        %R = add %i4 %q, < i32 -1, i32 -1, i32 -1, i32 -1 >             
        store %i4 %R, %i4* %P
        ret void
}
...
define void @splat_imm_i16(%i4* %P, %i4* %Q, i32 %X) nounwind {
        %q = load %i4, %i4* %Q               
        %R = add %i4 %q, < i32 65537, i32 65537, i32 65537, i32 65537 >         
        store %i4 %R, %i4* %P
        ret void
}
...
define void @spltish(<16 x i8>* %A, <16 x i8>* %B) nounwind {
        %tmp = load <16 x i8>, <16 x i8>* %B               
        %tmp.s = bitcast <16 x i8> %tmp to <16 x i8>            
        %tmp4 = sub <16 x i8> %tmp.s, bitcast (<8 x i16> < i16 15, i16 15, i16 15, i16 15, i16 15, i16
 15, i16 15, i16 15 > to <16 x i8>)             
        %tmp4.u = bitcast <16 x i8> %tmp4 to <16 x i8>          
