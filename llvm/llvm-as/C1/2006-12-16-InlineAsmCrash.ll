...
define i1 @_ZNK12QImageWriter8canWriteEv() {
	%tmp62 = load %struct.QImageWriterPrivate*, %struct.QImageWriterPrivate** null		
	%tmp = getelementptr %struct.QImageWriterPrivate, %struct.QImageWriterPrivate* %tmp62, i32 0, i32 9		
	%tmp75 = call %struct.QString* @_ZN7QStringaSERKS_( %struct.QString* %tmp, %struct.QString* null )		
