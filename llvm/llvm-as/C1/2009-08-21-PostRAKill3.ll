...
bb1:                                              
  ...
  %exp2 = call double @ldexp(double 1.000000e+00, i32 %level) nounwind 
  %.c = fptosi double %exp2 to i32                
  store i32 %.c, i32* null
  %1 = getelementptr %struct.Village, %struct.Village* %0, i32 0, i32 3, i32 6, i32 0 
  store %struct.List* null, %struct.List** %1
  %2 = getelementptr %struct.Village, %struct.Village* %0, i32 0, i32 3, i32 6, i32 2 
