...
bb2.i.i.i:		
	%tmp24.i.i.i = call double @pow( double 0.000000e+00, double 2.000000e+00 )		
	ret void
bb47.i.i.i:		
...
cond_next119.i:		
	%curr_ptr.0.reg2mem.0.i = phi %struct.ch_set* [ %tmp106.i, %cond_false99.i ], [ null, %bb42 ]		
	%prev_ptr.0.reg2mem.0.i = phi %struct.ch_set* [ %curr_ptr.0.reg2mem.0.i, %cond_false99.i ], [ undef, %bb42 ]		
	br i1 false, label %bb126.i, label %bb17.i
bb126.i:		
	%prev_ptr.0.reg2mem.1.i = phi %struct.ch_set* [ %prev_ptr.0.reg2mem.0.i, %cond_next119.i ], [ %curr_ptr.0.reg2mem.0.i, %cond_false99.i ]		
	ret { i16, %struct.rnode* }* null
bb78:		
	ret { i16, %struct.rnode* }* null
}
