...
cond_next54.i:		
	%tmp10.i.i527 = call i8* @calloc( i64 0, i64 1 )		
...
cond_true784.i:		
	%indvar1411.i.reg2mem.0 = phi i8 [ %indvar.next1412.i, %cond_next811.i ], [ 0, %cond_false742.i ]		
	br i1 false, label %cond_true1008.critedge1190.i, label %cond_next811.i

cond_next811.i:		
	%indvar.next1412.i = add i8 %indvar1411.i.reg2mem.0, 1		
	%tmp781.i = icmp eq i8 %indvar.next1412.i, 3		
	br i1 %tmp781.i, label %cond_next9079, label %cond_true784.i

cond_next862.i:		
	ret i32 0

cond_true1008.critedge.i:		
	ret i32 0

cond_true1008.critedge1171.i:		
	ret i32 0

cond_true1008.critedge1185.i:		
	ret i32 0

cond_true1008.critedge1190.i:		
	%tmp621.i532.lcssa610 = phi i8* [ %tmp10.i.i527, %cond_true784.i ]		
	ret i32 0
