...
define internal void @""(i8*, i32, i8*) {
        ...
        %7 = getelementptr i8, i8* %2, i32 %.0              
        %8 = bitcast i8* %7 to <4 x i16>*               
        %9 = load <4 x i16>, <4 x i16>* %8, align 1                
        %10 = bitcast <4 x i16> %9 to <1 x i64>         
        %11 = call <2 x i64> @foo(<1 x i64> %10)

        %12 = bitcast <2 x i64> %11 to <4 x i32>                
        %13 = bitcast <4 x i32> %12 to <8 x i16>                
        %14 = shufflevector <8 x i16> %13, <8 x i16> %13, <8 x i32> < i32 0, i32 0, i32 1, i32 1, i32 2, i32 2, i32 3, i32 3 >          
        %15 = bitcast <8 x i16> %14 to <4 x i32>                
        %16 = sitofp <4 x i32> %15 to <4 x float>               
        %17 = getelementptr i8, i8* %0, i32 %.0             
