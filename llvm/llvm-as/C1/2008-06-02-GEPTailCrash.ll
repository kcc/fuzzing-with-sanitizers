...
target triple = "i686-pc-linux-gnu"
	...
	%union.anon = type {  }
@a291 = external global [5 x %struct.S291]		
...
entry:
	...
	%tmp54 = load i32, i32* bitcast (%struct.S291* getelementptr ([5 x %struct.S291], [5 x %struct.S291]* @a291, i32 0, i32 2) to i32*), align 4		
	unreachable
}
