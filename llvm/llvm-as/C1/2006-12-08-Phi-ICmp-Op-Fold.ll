...
cond_true:		
	...
	%tmp14.upgrd.4 = zext i1 %tmp14 to i32		
	br label %return

cond_false:		
	%tmp26 = icmp sgt i32 %tmp13, 0		
	%tmp26.upgrd.5 = zext i1 %tmp26 to i32		
	br label %return

return:		
	%retval.0 = phi i32 [ %tmp14.upgrd.4, %cond_true ], [ %tmp26.upgrd.5, %cond_false ]		
	ret i32 %retval.0
}
