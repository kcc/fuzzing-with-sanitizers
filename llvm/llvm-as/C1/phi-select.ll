...
entry:
  ...
  %b = alloca %struct.X, align 8                  
  %0 = getelementptr inbounds %struct.X, %struct.X* %a, i64 0, i32 0 
  store i32 1, i32* %0, align 8
  %1 = getelementptr inbounds %struct.X, %struct.X* %b, i64 0, i32 0 
  store i32 2, i32* %1, align 8
  %2 = icmp eq i32 %x, 0                          
  %p.0 = select i1 %2, %struct.X* %b, %struct.X* %a 
  %3 = getelementptr inbounds %struct.X, %struct.X* %p.0, i64 0, i32 0 
