...
entry:
	%tmp1112 = sitofp i16 0 to ppc_fp128		
	%tmp13 = call i32 (...) @__inline_isfinite( ppc_fp128 %tmp1112 ) nounwind 		
	ret i32 0
}

define i32 @stp_sequence_set_short_data2(%struct.stp_sequence* %sequence, i32 %count, i16* %data) {
entry:
	%tmp1112 = sitofp i8 0 to ppc_fp128		
	%tmp13 = call i32 (...) @__inline_isfinite( ppc_fp128 %tmp1112 ) nounwind 		
	ret i32 0
}
...
entry:
	%tmp1112 = uitofp i16 0 to ppc_fp128		
	%tmp13 = call i32 (...) @__inline_isfinite( ppc_fp128 %tmp1112 ) nounwind 		
	ret i32 0
}
...
entry:
	%tmp1112 = uitofp i8 0 to ppc_fp128		
	%tmp13 = call i32 (...) @__inline_isfinite( ppc_fp128 %tmp1112 ) nounwind 		
	ret i32 0
}
