...
entry:
  ...
  %4 = call i8* @llvm.stacksave(), !dbg !7        
  store i8* %4, i8** %saved_stack.1, align 8, !dbg !7
  %5 = load i8*, i8** %s1_addr, align 8, !dbg !13      
  %6 = call i64 @strlen(i8* %5) nounwind readonly, !dbg !13 
  %7 = add i64 %6, 1, !dbg !13                    
  store i64 %7, i64* %3, align 8, !dbg !13
  %8 = load i64, i64* %3, align 8, !dbg !13            
  %9 = sub nsw i64 %8, 1, !dbg !13                
  %10 = load i64, i64* %3, align 8, !dbg !13           
  %11 = mul i64 %10, 8, !dbg !13                  
  %12 = load i64, i64* %3, align 8, !dbg !13           
  store i64 %12, i64* %2, align 8, !dbg !13
  %13 = load i64, i64* %3, align 8, !dbg !13           
  %14 = mul i64 %13, 8, !dbg !13                  
  %15 = load i64, i64* %3, align 8, !dbg !13           
  store i64 %15, i64* %1, align 8, !dbg !13
  %16 = load i64, i64* %1, align 8, !dbg !13           
  %17 = trunc i64 %16 to i32, !dbg !13            
  %18 = alloca i8, i32 %17, !dbg !13              
  %19 = bitcast i8* %18 to [0 x i8]*, !dbg !13    
  store [0 x i8]* %19, [0 x i8]** %str.0, align 8, !dbg !13
  %20 = load [0 x i8]*, [0 x i8]** %str.0, align 8, !dbg !15 
  %21 = getelementptr inbounds [0 x i8], [0 x i8]* %20, i64 0, i64 0, !dbg !15 
  store i8 0, i8* %21, align 1, !dbg !15
  %22 = load [0 x i8]*, [0 x i8]** %str.0, align 8, !dbg !16 
  %23 = getelementptr inbounds [0 x i8], [0 x i8]* %22, i64 0, i64 0, !dbg !16 
  %24 = load i8, i8* %23, align 1, !dbg !16           
  %25 = sext i8 %24 to i32, !dbg !16              
  store i32 %25, i32* %0, align 4, !dbg !16
  %26 = load i8*, i8** %saved_stack.1, align 8, !dbg !16 
  call void @llvm.stackrestore(i8* %26), !dbg !16
  %27 = load i32, i32* %0, align 4, !dbg !16           
  store i32 %27, i32* %retval, align 4, !dbg !16
  br label %return, !dbg !16

return:                                           
  %retval1 = load i32, i32* %retval, !dbg !16          
  %retval12 = trunc i32 %retval1 to i8, !dbg !16  
