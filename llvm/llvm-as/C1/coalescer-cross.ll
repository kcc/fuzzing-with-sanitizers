	...
	%0 = type { %struct.TValue }		
	%1 = type { %struct.L_Umaxalign, i32, %struct.Node* }		
...
@llvm.used = appending global [1 x i8*] [i8* bitcast (i32 (%struct.lua_State*)* @os_clock to i8*)], section "llvm.metadata"		

define i32 @os_clock(%struct.lua_State* nocapture %L) nounwind ssp {
entry:
	%0 = tail call i32 @"\01_clock$UNIX2003"() nounwind		
	%1 = uitofp i32 %0 to double		
	%2 = fdiv double %1, 1.000000e+06		
	%3 = getelementptr %struct.lua_State, %struct.lua_State* %L, i32 0, i32 4		
	%4 = load %struct.TValue*, %struct.TValue** %3, align 4		
	%5 = getelementptr %struct.TValue, %struct.TValue* %4, i32 0, i32 0, i32 0		
	store double %2, double* %5, align 4
	%6 = getelementptr %struct.TValue, %struct.TValue* %4, i32 0, i32 1		
	store i32 3, i32* %6, align 4
	%7 = load %struct.TValue*, %struct.TValue** %3, align 4		
	%8 = getelementptr %struct.TValue, %struct.TValue* %7, i32 1		
