...
@_ZTVSt9basic_iosIcSt11char_traitsIcEE = external constant [4 x i32 (...)*]		
@_ZTTSt19basic_ostringstreamIcSt11char_traitsIcESaIcEE = external constant [4 x i8*]		
@_ZTVSt19basic_ostringstreamIcSt11char_traitsIcESaIcEE = external constant [10 x i32 (...)*]		
@_ZTVSt15basic_streambufIcSt11char_traitsIcEE = external constant [16 x i32 (...)*]		
@_ZTVSt15basic_stringbufIcSt11char_traitsIcESaIcEE = external constant [16 x i32 (...)*]		
...
entry:
	...
	%tmp96.i.i142.i = call i8* @_Znwm( i32 180 ) nounwind 		
	...
	%ctg2242.i.i163.i = getelementptr i8, i8* %tmp96.i.i142.i, i32 0		
	%tmp150.i.i164.i = load i8*, i8** getelementptr ([4 x i8*], [4 x i8*]* @_ZTTSt19basic_ostringstreamIcSt11char_traitsIcESaIcEE, i32 0, i64 2), align 4		
	%tmp150151.i.i165.i = bitcast i8* %tmp150.i.i164.i to i32 (...)**		
	%tmp153.i.i166.i = bitcast i8* %ctg2242.i.i163.i to i32 (...)***		
	store i32 (...)** %tmp150151.i.i165.i, i32 (...)*** %tmp153.i.i166.i, align 4
	%tmp159.i.i167.i = bitcast i8* %tmp96.i.i142.i to i32 (...)***		
