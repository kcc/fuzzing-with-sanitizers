...
@_ZTV1D = linkonce_odr constant [6 x i8*] [i8* null, i8* bitcast (%2* @_ZTI1D to i8*), i8* bitcast (i32 (%struct.C*)* @_ZN1D1fEv to i8*), i8* inttoptr (i64 -8 to i8*), i8* bitcast (%2* @_ZTI1D to i8*), i8* bitcast (i32 (%struct.C*)* @_ZThn8_N1D1fEv to i8*)] 
...
@_ZTI1A = linkonce_odr constant %0 { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_ZTS1A, i32 0, i32 0) } 
@_ZTS1B = linkonce_odr constant [3 x i8] c"1B\00"     
@_ZTI1B = linkonce_odr constant %0 { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv117__class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_ZTS1B, i32 0, i32 0) } 
@_ZTI1C = linkonce_odr constant %1 { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv121__vmi_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_ZTS1C, i32 0, i32 0), i32 0, i32 2, i8* bitcast (%0* @_ZTI1A to i8*), i64 2, i8* bitcast (%0* @_ZTI1B to i8*), i64 2050 } 
@_ZTI1D = linkonce_odr constant %2 { i8* bitcast (i8** getelementptr inbounds (i8*, i8** @_ZTVN10__cxxabiv120__si_class_type_infoE, i64 2) to i8*), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @_ZTS1D, i32 0, i32 0), i8* bitcast (%1* @_ZTI1C to i8*) } 
@_ZTV1C = linkonce_odr constant [6 x i8*] [i8* null, i8* bitcast (%1* @_ZTI1C to i8*), i8* bitcast (i32 (%struct.C*)* @_ZN1C1fEv to i8*), i8* inttoptr (i64 -8 to i8*), i8* bitcast (%1* @_ZTI1C to i8*), i8* bitcast (i32 (%struct.C*)* @_ZThn8_N1C1fEv to i8*)] 
@_ZTV1B = linkonce_odr constant [3 x i8*] [i8* null, i8* bitcast (%0* @_ZTI1B to i8*), i8* bitcast (i32 (%struct.A*)* @_ZN1B1fEv to i8*)] 
@_ZTV1A = linkonce_odr constant [3 x i8*] [i8* null, i8* bitcast (%0* @_ZTI1A to i8*), i8* bitcast (i32 (%struct.A*)* @_ZN1A1fEv to i8*)] 

define i32 @_Z1gv() ssp {
entry:
  %d = alloca %struct.C, align 8                  
...
entry:
  %0 = icmp eq %struct.C* %d, null                
  br i1 %0, label %cast.end, label %cast.notnull

cast.notnull:                                     
  %1 = bitcast %struct.C* %d to i8*               
  %add.ptr = getelementptr i8, i8* %1, i64 8          
  %2 = bitcast i8* %add.ptr to %struct.A*         
  br label %cast.end

cast.end:                                         
  %3 = phi %struct.A* [ %2, %cast.notnull ], [ null, %entry ] 
  %4 = bitcast %struct.A* %3 to i32 (%struct.A*)*** 
  %5 = load i32 (%struct.A*)**, i32 (%struct.A*)*** %4                
  %vfn = getelementptr inbounds i32 (%struct.A*)*, i32 (%struct.A*)** %5, i64 0 
  %6 = load i32 (%struct.A*)*, i32 (%struct.A*)** %vfn               
  %call = call i32 %6(%struct.A* %3)              
  ret i32 %call
}
...
entry:
  ...
  %call = call i32 @_ZN1D1fEv(%struct.C* %2)      
  ret i32 %call
}
...
entry:
  ...
  %1 = getelementptr inbounds i8, i8* %0, i64 -8      
  %2 = bitcast i8* %1 to %struct.C*               
  %call = call i32 @_ZN1C1fEv(%struct.C* %2)      
  ret i32 %call
}
