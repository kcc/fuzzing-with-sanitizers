...
@uart_classes = internal global [3 x %struct.uart_class*] [%struct.uart_class* @uart_ns8250_class, %struct.uart_class* @uart_sab82532_class, %struct.uart_class* @uart_z8530_class], align 8		
@uart_ns8250_class = extern_weak global %struct.uart_class		
@uart_sab82532_class = extern_weak global %struct.uart_class		
@uart_z8530_class = extern_weak global %struct.uart_class		
