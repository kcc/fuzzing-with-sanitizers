...
define <4 x float> @test_x86_vcvtph2ps_128(<8 x i16> %a0) {
  ...
  %res = call <4 x float> @llvm.x86.vcvtph2ps.128(<8 x i16> %a0) 
  ret <4 x float> %res
}
...
define <8 x float> @test_x86_vcvtph2ps_256(<8 x i16> %a0) {
  ...
  %res = call <8 x float> @llvm.x86.vcvtph2ps.256(<8 x i16> %a0) 
  ret <8 x float> %res
}
...
define <8 x i16> @test_x86_vcvtps2ph_256(<8 x float> %a0) {
  ...
  %res = call <8 x i16> @llvm.x86.vcvtps2ph.256(<8 x float> %a0, i32 0) 
  ret <8 x i16> %res
}
