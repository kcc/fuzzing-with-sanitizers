...
bb.i19:                                           
  %0 = insertelement <4 x float> undef, float undef, i32 3 
  %1 = fmul <4 x float> %0, %0                    
  %2 = bitcast <4 x float> %1 to <2 x double>     
  %3 = fmul <4 x float> %0, undef                 
  br label %bb.i19
}
...
entry:
  ...
  %0 = load <16 x i8>, <16 x i8>* undef, align 16            
  %1 = or <16 x i8> zeroinitializer, %0           
