...
then.0:
	br label %no_exit.2
no_exit.2:		
	%indvar630 = phi i32 [ 0, %then.0 ], [ %indvar.next631, %no_exit.2 ]		
	%gep.upgrd.1 = zext i32 %indvar630 to i64		
	...
	%tmp.34 = icmp slt i32 %inc.2, 701		
	%indvar.next631 = add i32 %indvar630, 1		
