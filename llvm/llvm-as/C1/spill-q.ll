...
entry:
  ...
  %1 = call <4 x float> @llvm.arm.neon.vld1.v4f32(i8* undef, i32 1) nounwind 
  store float 0.000000e+00, float* undef, align 4
  %2 = call <4 x float> @llvm.arm.neon.vld1.v4f32(i8* undef, i32 1) nounwind 
  ...
  store float 0.000000e+00, float* undef, align 4
  %val173 = load <4 x float>, <4 x float>* undef               
  br label %bb4

bb4:                                              
  %besterror.0.2264 = phi <4 x float> [ undef, %entry ], [ %besterror.0.0, %bb193 ] 
  %part0.0.0261 = phi <4 x float> [ zeroinitializer, %entry ], [ %23, %bb193 ] 
  %3 = fmul <4 x float> zeroinitializer, %0       
  %4 = fadd <4 x float> %3, %part0.0.0261         
  ...
  %7 = fmul <4 x float> %1, undef                 
  %8 = fadd <4 x float> %7, <float 5.000000e-01, float 5.000000e-01, float 5.000000e-01, float 5.000000e-01> 
  %9 = fptosi <4 x float> %8 to <4 x i32>         
  %10 = sitofp <4 x i32> %9 to <4 x float>        
  %11 = fmul <4 x float> %10, %2                  
  %12 = fmul <4 x float> undef, %6                
  %13 = fmul <4 x float> %11, %4                  
  %14 = fsub <4 x float> %12, %13                 
  %15 = fsub <4 x float> %14, undef               
  %16 = fmul <4 x float> %15, <float 2.000000e+00, float 2.000000e+00, float 2.000000e+00, float 2.000000e+00> 
  %17 = fadd <4 x float> %16, undef               
  %18 = fmul <4 x float> %17, %val173             
  %19 = shufflevector <4 x float> %18, <4 x float> undef, <2 x i32> <i32 2, i32 3> 
  %20 = shufflevector <2 x float> %19, <2 x float> undef, <4 x i32> zeroinitializer 
  ...
  %22 = fcmp ogt <4 x float> %besterror.0.2264, %21 
...
bb193:                                            
  %besterror.0.0 = phi <4 x float> [ %21, %bb186 ], [ %besterror.0.2264, %bb4 ] 
  %23 = fadd <4 x float> %part0.0.0261, zeroinitializer 
  br label %bb4
}
