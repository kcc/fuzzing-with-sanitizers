...
@str14 = external global [6 x i8]		

declare void @fprintf(i32, ...)

define void @OUTPUT_TABLE(%struct.SYMBOL_TABLE_ENTRY* %SYM_TAB) {
entry:
	%tmp11 = getelementptr %struct.SYMBOL_TABLE_ENTRY, %struct.SYMBOL_TABLE_ENTRY* %SYM_TAB, i32 0, i32 1, i32 0		
	%tmp.i = bitcast i8* %tmp11 to i8*		
	br label %bb.i

bb.i:		
	%s1.0.i = phi i8* [ %tmp.i, %entry ], [ null, %cond_next.i ]		
