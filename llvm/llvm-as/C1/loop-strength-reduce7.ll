...
bb28.i37:		
	%i.1.reg2mem.0.i = phi i32 [ %0, %bb33.i47 ], [ 0, %bb5 ]		
	%0 = add i32 %i.1.reg2mem.0.i, 1		
	br label %bb29.i38

bb29.i38:		
	%indvar32.i = phi i32 [ %indvar.next33.i, %bb33.i47 ], [ 0, %bb28.i37 ]		
	%sfb.314.i = add i32 %indvar32.i, 0		
	%1 = getelementptr [4 x [21 x double]], [4 x [21 x double]]* null, i32 0, i32 %0, i32 %sfb.314.i		
	%2 = load double, double* %1, align 8		
	br i1 false, label %bb30.i41, label %bb33.i47

bb30.i41:		
	%3 = getelementptr %struct.III_scalefac_t, %struct.III_scalefac_t* null, i32 0, i32 1, i32 %sfb.314.i, i32 %i.1.reg2mem.0.i		
	store i32 0, i32* %3, align 4
	br label %bb33.i47

bb33.i47:		
	%4 = add i32 %sfb.314.i, 1		
	%phitmp.i46 = icmp ugt i32 %4, 11		
