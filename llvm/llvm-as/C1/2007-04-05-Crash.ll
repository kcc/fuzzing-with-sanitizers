...
@replacementUnichar = internal global i16 -3		
@"L_OBJC_IMAGE_INFO" = internal global [2 x i32] zeroinitializer		
@llvm.used = appending global [1 x i8*] [ i8* bitcast ([2 x i32]* @"L_OBJC_IMAGE_INFO" to i8*) ]		
...
entry:
	...
	%iftmp.0.0.in = load i16, i16* %iftmp.0.0.in.in		
