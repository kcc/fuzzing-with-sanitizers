...
entry:
	...
	%2 = zext i64 %tmp121 to i192		
	%3 = shl i192 %2, 64		
	%4 = zext i64 %tmp122 to i192		
	%5 = shl i192 %4, 128		
	%6 = or i192 %3, %1		
	%7 = or i192 %6, %5		
...
bb29:		
	%tmp18.i = and i192 %3, 1208907372870555465154560		
	%mask.i = or i192 %tmp18.i, %1		
	%mask41.i = or i192 %mask.i, 0		
	br label %bb82
...
bb82:		
	%d.0 = phi i192 [ %mask41.i, %bb29 ], [ undef, %bb38 ], [ %7, %entry ], [ %7, %bb21 ]		
	%tmp51 = trunc i192 %d.0 to i64		
	ret void
}
