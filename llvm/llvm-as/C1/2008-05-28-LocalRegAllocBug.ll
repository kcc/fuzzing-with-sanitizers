...
@_ZTVN10Evaluation10GridOutputILi3EEE = external constant [5 x i32 (...)*]		
...
bb37:		
	%tmp12.i.i.i.i.i66 = invoke i8* @_Znwm( i32 12 )
			to label %tmp12.i.i.i.i.i.noexc65 unwind label %lpad243		

tmp12.i.i.i.i.i.noexc65:		
	unreachable
...
lpad243:		
	...
	%tmp133 = call i8* @__cxa_begin_catch( i8* %eh_ptr244 ) nounwind 		
	unreachable
}
