...
entry:
  ...
  %arg0_uint16x4_t = alloca <4 x i16>             
  %out_uint16_t = alloca i16                      
  %"alloca point" = bitcast i32 0 to i32          
  %0 = load <4 x i16>, <4 x i16>* %arg0_uint16x4_t, align 8  
...
entry:
  ...
  %arg0_uint8x8_t = alloca <8 x i8>               
  %out_uint8_t = alloca i8                        
  %"alloca point" = bitcast i32 0 to i32          
  %0 = load <8 x i8>, <8 x i8>* %arg0_uint8x8_t, align 8    
...
entry:
  ...
  %arg0_uint16x8_t = alloca <8 x i16>             
  %out_uint16_t = alloca i16                      
  %"alloca point" = bitcast i32 0 to i32          
  %0 = load <8 x i16>, <8 x i16>* %arg0_uint16x8_t, align 16 
...
entry:
  ...
  %arg0_uint8x16_t = alloca <16 x i8>             
  %out_uint8_t = alloca i8                        
  %"alloca point" = bitcast i32 0 to i32          
  %0 = load <16 x i8>, <16 x i8>* %arg0_uint8x16_t, align 16 
...
entry:
  %0 = insertelement <2 x float> %arg1_float32x2_t, float %arg0_float32_t, i32 1 
  ret <2 x float> %0
}
