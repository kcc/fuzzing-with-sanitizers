...
bb58.i:
	%tmp3405.i = getelementptr %struct.XTRec, %struct.XTRec* null, i32 0, i32 1		
	%tmp34053406.i = bitcast float* %tmp3405.i to i8*		
	%tmp3407.i = call <4 x i32> @llvm.ppc.altivec.lvewx( i8* %tmp34053406.i )		
	%tmp4146.i = call i32 @llvm.ppc.altivec.vcmpequw.p( i32 3, <4 x i32> zeroinitializer, <4 x i32> zeroinitializer )		
	%tmp4147.i = icmp eq i32 %tmp4146.i, 0		
