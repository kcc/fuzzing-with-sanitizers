...
entry:
	...
	%asmresult1 = extractvalue { i32, i32, i32, i32, i32 } %asmtmp, 1		
	%asmresult116 = zext i32 %asmresult1 to i64		
	%asmresult116.ins = or i64 0, %asmresult116		
	%1 = lshr i64 %v, 32		
	%2 = mul i64 %1, %u		
	%3 = add i64 %2, 0		
	%4 = shl i64 %3, 32		
	%5 = add i64 %asmresult116.ins, %4		
	ret i64 %5
}
