...
@iodbcdm_global_lock = external global %struct.pthread_mutex_t		
...
entry:
	%tmp12 = bitcast i8* %henv to %struct.GENV_t*		
...
bb37:		
	%tmp46 = getelementptr %struct.GENV_t, %struct.GENV_t* %tmp12, i32 0, i32 10		
	store i16 0, i16* %tmp46, align 4
	br i1 false, label %bb74, label %bb92
bb74:		
	br label %bb92
bb92:		
	%tmp95180 = shl i16 %cbDrvAttrMax, 2		
	%tmp100178 = shl i16 %cbDrvDescMax, 2		
	%tmp113 = tail call i16 @SQLDrivers_Internal( i8* %henv, i16 zeroext  %fDir, i8* null, i16 signext  %tmp100178, i16* %pcbDrvDesc, i8* null, i16 signext  %tmp95180, i16* %pcbDrvAttr, i8 zeroext  87 )  nounwind 		
	br i1 false, label %done, label %bb137
bb137:		
	ret i16 0
done:		
	%retcode.0 = phi i16 [ -2, %bb28 ], [ %tmp113, %bb92 ]		
	br i1 false, label %bb167, label %bb150
bb150:		
	%tmp157158 = sext i16 %retcode.0 to i32		
	...
	ret i16 0
bb167:		
	%tmp168 = tail call i32 @pthread_mutex_unlock( %struct.pthread_mutex_t* @iodbcdm_global_lock ) nounwind 		
	ret i16 %retcode.0
}
