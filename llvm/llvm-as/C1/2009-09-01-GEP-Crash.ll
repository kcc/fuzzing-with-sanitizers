...
@per_cpu__hrtimer_bases = external global %1, align 8 

define void @init_hrtimers_cpu(i32 %cpu) nounwind noredzone section ".cpuinit.text" {
entry:
  %tmp3 = getelementptr %struct.hrtimer_cpu_base, %struct.hrtimer_cpu_base* bitcast (%1* @per_cpu__hrtimer_bases to %struct.hrtimer_cpu_base*), i32 0, i32 0 
  %tmp5 = bitcast %0* %tmp3 to i8*                
  unreachable
}
