...
entry:
	%v_addr = alloca <4 x i32>		
	%f_addr = alloca i32		
	%retval = alloca <4 x i32>		
	%0 = alloca <4 x i32>		
	%"alloca point" = bitcast i32 0 to i32		
	store <4 x i32> %v, <4 x i32>* %v_addr
	store i32 %f, i32* %f_addr
	%1 = load <4 x i32>, <4 x i32>* %v_addr, align 16		
	%2 = load i32, i32* %f_addr, align 4		
	...
	%6 = load <4 x i32>, <4 x i32>* %0, align 16		
	store <4 x i32> %6, <4 x i32>* %retval, align 16
	br label %return

return:		
	%retval1 = load <4 x i32>, <4 x i32>* %retval		
	ret <4 x i32> %retval1
}
