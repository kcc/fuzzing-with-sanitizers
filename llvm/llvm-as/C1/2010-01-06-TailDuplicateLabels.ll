...
@_ZN3WTFL8heap_keyE = internal global i32 0       
@_ZN3WTFL10tsd_initedE.b = internal global i1 false 
@_ZN3WTFL13pageheap_lockE = internal global %struct.SpinLock { %struct.PlatformMutex { i32 850045863, [40 x i8] zeroinitializer } } 
@_ZN3WTFL12thread_heapsE = internal global %"struct.WTF::TCMalloc_ThreadCache"* null 
@llvm.used = appending global [1 x i8*] [i8* bitcast (%"struct.WTF::TCMalloc_ThreadCache"* ()* @_ZN3WTF20TCMalloc_ThreadCache22CreateCacheIfNecessaryEv to i8*)], section "llvm.metadata" 
...
entry:
  ...
  %.b24 = load i1, i1* @_ZN3WTFL10tsd_initedE.b, align 4 
...
bb6:                                              
  %me.0 = phi %struct._opaque_pthread_t* [ %1, %bb5 ], [ null, %entry ] 
  br label %bb11
...
bb11:                                             
  %h.0.in = phi %"struct.WTF::TCMalloc_ThreadCache"** [ @_ZN3WTFL12thread_heapsE, %bb6 ], [ %6, %bb10 ] 
  %h.0 = load %"struct.WTF::TCMalloc_ThreadCache"*, %"struct.WTF::TCMalloc_ThreadCache"** %h.0.in, align 4 
...
bb14:                                             
  %heap.1 = phi %"struct.WTF::TCMalloc_ThreadCache"* [ %8, %bb13 ], [ %h.0, %bb7 ] 
  ...
  %toBool15not = icmp eq i8 %11, 0                
  br i1 %toBool15not, label %bb19, label %bb22

bb19:                                             
  %.b = load i1, i1* @_ZN3WTFL10tsd_initedE.b, align 4 
