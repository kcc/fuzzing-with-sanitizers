...
entry:
	%tmp8 = getelementptr %"struct.kc::impl_Ccode_option", %"struct.kc::impl_Ccode_option"* %a_unpsubterm, i32 0, i32 0, i32 0		
...
bb55:		
	%tmp67 = tail call i32 null( %"struct.kc::impl_abstract_phylum"* null )		
	%tmp97 = tail call i32 null( %"struct.kc::impl_abstract_phylum"* null )		
	ret %"struct.kc::impl_ID"* null
}
