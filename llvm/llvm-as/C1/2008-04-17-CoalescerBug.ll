...
@.str = external constant [27 x i32]		
@.str4 = external constant [14 x i32]		
@_ZZNK10wxDateTime5GetTmERKNS_8TimeZoneEE12__FUNCTION__ = external constant [6 x i8]		
@.str33 = external constant [29 x i32]		
@.str89 = external constant [5 x i32]		
...
bb182.i:		
	ret void
bb3261:		
	%tmp3263 = load i32, i32* null, align 4		
	%tmp3264 = icmp eq i32 %tmp3263, 37		
...
bb3306:		
	%tmp3310 = invoke %struct.wxStringBase* @_ZN12wxStringBaseaSEPKw( %struct.wxStringBase* null, i32* getelementptr ([5 x i32], [5 x i32]* @.str89, i32 0, i32 0) )
			to label %bb3314 unwind label %lpad		
bb3314:		
	%tmp3316 = load i32, i32* null, align 4		
...
bb5657:		
	%tmp5661 = invoke zeroext i16 @_ZNK10wxDateTime12GetDayOfYearERKNS_8TimeZoneE( %struct.wxDateTime* %this, %"struct.wxDateTime::TimeZone"* %tz )  
			to label %invcont5660 unwind label %lpad		
invcont5660:		
	ret void
bb5809:		
	%tmp61.i.i8486 = icmp sgt i64 0, -1		
	%tmp95.i.i8490 = icmp slt i64 0, 2147483647000		
	%bothcond9308 = and i1 %tmp61.i.i8486, %tmp95.i.i8490		
	br i1 %bothcond9308, label %bb91.i8504, label %bb115.critedge.i.i8492
bb115.critedge.i.i8492:		
	ret void
bb91.i8504:		
	br i1 %foo, label %bb155.i8541, label %bb182.i8560
bb155.i8541:		
	%tmp156.i85398700 = invoke %struct.tm* @gmtime_r( i32* null, %struct.tm* null )
			to label %bb182.i8560 unwind label %lpad		
bb182.i8560:		
	%tm48.0.i8558 = phi %struct.tm* [ null, %bb91.i8504 ], [ %tmp156.i85398700, %bb155.i8541 ]		
	br i1 %foo, label %bb278.i8617, label %bb187.i8591
bb187.i8591:		
	%tmp245.i8588 = srem i64 0, 86400000		
	br i1 %foo, label %bb264.i8592, label %bb265.i8606
bb264.i8592:		
	ret void
bb265.i8606:		
	%tmp268269.i8593 = trunc i64 %tmp245.i8588 to i32		
	%tmp273.i8594 = srem i32 %tmp268269.i8593, 1000		
	%tmp273274.i8595 = trunc i32 %tmp273.i8594 to i16		
	br label %invcont5814
bb278.i8617:		
	%timeOnly50.0.i8622 = add i32 0, 0		
...
bb448.i8694:		
	%tmp477.i8669 = srem i32 %timeOnly50.0.i8622, 1000		
	%tmp477478.i8670 = trunc i32 %tmp477.i8669 to i16		
	br label %invcont5814
invcont5814:		
	%tmp812.0.0 = phi i16 [ %tmp477478.i8670, %bb448.i8694 ], [ %tmp273274.i8595, %bb265.i8606 ]		
	%tmp58165817 = zext i16 %tmp812.0.0 to i32		
...
invcont5831:		
	%tmp5862 = invoke zeroext  i8 @_ZN12wxStringBase10ConcatSelfEmPKwm( %struct.wxStringBase* null, i32 0, i32* null, i32 0 ) 
			to label %bb7834 unwind label %lpad8185		
bb5968:		
...
bb7806:		
	%tmp7814 = invoke %struct.wxStringBase* @_ZN12wxStringBase6appendEmw( %struct.wxStringBase* null, i32 1, i32 0 )
			to label %bb7834 unwind label %lpad		
bb7819:		
	ret void
bb7834:		
	br label %bb3261
