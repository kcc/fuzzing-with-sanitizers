...
entry:
	%tmp50.i.i = mul i32 0, 0		
	br i1 false, label %init_orig_buffers.exit, label %cond_true.i29

cond_true.i29:		
	%tmp17.i = load i32, i32* getelementptr (%struct.ImageParameters, %struct.ImageParameters* @images, i32 0, i32 20), align 8		
	%tmp20.i27 = load i32, i32* getelementptr (%struct.ImageParameters, %struct.ImageParameters* @images, i32 0, i32 16), align 8		
	%tmp8.i.i = select i1 false, i32 1, i32 0		
	br label %bb.i8.us.i

bb.i8.us.i:		
	%j.04.i.us.i = phi i32 [ %indvar.next39.i, %get_mem2Dpel.exit.i.us.i ], [ 0, %cond_true.i29 ]		
	%tmp13.i.us.i = getelementptr i16**, i16*** null, i32 %j.04.i.us.i		
	%tmp15.i.i.us.i = tail call i8* @calloc( i32 0, i32 2 )		
	store i16* null, i16** null, align 4
	br label %bb.i.i.us.i

get_mem2Dpel.exit.i.us.i:		
	%indvar.next39.i = add i32 %j.04.i.us.i, 1		
	%exitcond40.i = icmp eq i32 %indvar.next39.i, 2		
	br i1 %exitcond40.i, label %get_mem3Dpel.exit.split.i, label %bb.i8.us.i

bb.i.i.us.i:		
	%exitcond.i = icmp eq i32 0, %tmp8.i.i		
	br i1 %exitcond.i, label %get_mem2Dpel.exit.i.us.i, label %bb.i.i.us.i

get_mem3Dpel.exit.split.i:		
	%tmp30.i.i = shl i32 %tmp17.i, 2		
	%tmp31.i.i = mul i32 %tmp30.i.i, %tmp20.i27		
	%tmp23.i31 = add i32 %tmp31.i.i, %tmp50.i.i		
	br label %init_orig_buffers.exit

init_orig_buffers.exit:		
	%memory_size.0.i = phi i32 [ %tmp23.i31, %get_mem3Dpel.exit.split.i ], [ %tmp50.i.i, %entry ]		
	%tmp41 = add i32 0, %memory_size.0.i		
	unreachable
}
