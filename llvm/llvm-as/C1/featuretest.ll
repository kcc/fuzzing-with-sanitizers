...
define i32 @gep_distance_test(i32* %A) {
        ...
        %B = getelementptr i32, i32* %A, i64 2  
        store i32 7, i32* %B
...
entry:
  %sum5.cast = zext i5 %j to i64             
  %P1 = getelementptr i16, i16* %row2col, i64 %sum5.cast
  %row2col.load.1.2 = load i16, i16* %P1, align 1 
  
  %sum13.cast31 = sext i5 %j to i6          
  %sum13.cast = zext i6 %sum13.cast31 to i64      
  %P2 = getelementptr i16, i16* %row2col, i64 %sum13.cast
  %row2col.load.1.6 = load i16, i16* %P2, align 1 
  
  %.ret = sub i16 %row2col.load.1.6, %row2col.load.1.2 
  ret i16 %.ret
