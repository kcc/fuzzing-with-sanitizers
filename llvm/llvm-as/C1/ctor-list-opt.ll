...
@G2 = global i32 0		
@G3 = global i32 -123		
@X = global { i32, [2 x i32] } { i32 0, [2 x i32] [ i32 17, i32 21 ] }		
@Y = global i32 -1		
@Z = global i32 123		
@D = global double 0.000000e+00		
@CTORGV = internal global i1 false		
...
define internal void @CTOR5() {
	%X.2p = getelementptr inbounds { i32, [2 x i32] }, { i32, [2 x i32] }* @X, i32 0, i32 1, i32 0		
	%X.2 = load i32, i32* %X.2p		
	%X.1p = getelementptr inbounds { i32, [2 x i32] }, { i32, [2 x i32] }* @X, i32 0, i32 0		
...
define internal void @CTOR8() {
	%X = call double @cos( double 0.000000e+00 )		
