...
entry:
	%x = alloca [19 x i8]		
	%tmp = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 0		
	store i8 %c, i8* %tmp, align 1
	%tmp5 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 1		
	store i8 %c, i8* %tmp5, align 1
	%tmp9 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 2		
	store i8 %c, i8* %tmp9, align 1
	%tmp13 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 3		
	store i8 %c, i8* %tmp13, align 1
	%tmp17 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 4		
	store i8 %c, i8* %tmp17, align 1
	%tmp21 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 5		
	store i8 %c, i8* %tmp21, align 1
	%tmp25 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 6		
	store i8 %c, i8* %tmp25, align 1
	%tmp29 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 7		
	store i8 %c, i8* %tmp29, align 1
	%tmp33 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 8		
	store i8 %c, i8* %tmp33, align 1
	%tmp37 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 9		
	store i8 %c, i8* %tmp37, align 1
	%tmp41 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 10		
	store i8 %c, i8* %tmp41, align 1
	%tmp45 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 11		
	store i8 %c, i8* %tmp45, align 1
	%tmp49 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 12		
	store i8 %c, i8* %tmp49, align 1
	%tmp53 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 13		
	store i8 %c, i8* %tmp53, align 1
	%tmp57 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 14		
	store i8 %c, i8* %tmp57, align 1
	%tmp61 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 15		
	store i8 %c, i8* %tmp61, align 1
	%tmp65 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 16		
	store i8 %c, i8* %tmp65, align 1
	%tmp69 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 17		
	store i8 %c, i8* %tmp69, align 1
	%tmp73 = getelementptr [19 x i8], [19 x i8]* %x, i32 0, i32 18		
...
entry:
	%ref_idx = alloca [8 x i8]		
	%left_mvd = alloca [8 x %struct.MV]		
	%up_mvd = alloca [8 x %struct.MV]		
	%tmp20 = getelementptr [8 x i8], [8 x i8]* %ref_idx, i32 0, i32 7		
	store i8 -1, i8* %tmp20, align 1
	%tmp23 = getelementptr [8 x i8], [8 x i8]* %ref_idx, i32 0, i32 6		
	store i8 -1, i8* %tmp23, align 1
	%tmp26 = getelementptr [8 x i8], [8 x i8]* %ref_idx, i32 0, i32 5		
	store i8 -1, i8* %tmp26, align 1
	%tmp29 = getelementptr [8 x i8], [8 x i8]* %ref_idx, i32 0, i32 4		
	store i8 -1, i8* %tmp29, align 1
	%tmp32 = getelementptr [8 x i8], [8 x i8]* %ref_idx, i32 0, i32 3		
	store i8 -1, i8* %tmp32, align 1
	%tmp35 = getelementptr [8 x i8], [8 x i8]* %ref_idx, i32 0, i32 2		
	store i8 -1, i8* %tmp35, align 1
	%tmp38 = getelementptr [8 x i8], [8 x i8]* %ref_idx, i32 0, i32 1		
	store i8 -1, i8* %tmp38, align 1
	%tmp41 = getelementptr [8 x i8], [8 x i8]* %ref_idx, i32 0, i32 0		
	store i8 -1, i8* %tmp41, align 1
	%tmp43 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 7, i32 0		
	store i16 0, i16* %tmp43, align 2
	%tmp46 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 7, i32 1		
	store i16 0, i16* %tmp46, align 2
	%tmp57 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 6, i32 0		
	store i16 0, i16* %tmp57, align 2
	%tmp60 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 6, i32 1		
	store i16 0, i16* %tmp60, align 2
	%tmp71 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 5, i32 0		
	store i16 0, i16* %tmp71, align 2
	%tmp74 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 5, i32 1		
	store i16 0, i16* %tmp74, align 2
	%tmp85 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 4, i32 0		
	store i16 0, i16* %tmp85, align 2
	%tmp88 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 4, i32 1		
	store i16 0, i16* %tmp88, align 2
	%tmp99 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 3, i32 0		
	store i16 0, i16* %tmp99, align 2
	%tmp102 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 3, i32 1		
	store i16 0, i16* %tmp102, align 2
	%tmp113 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 2, i32 0		
	store i16 0, i16* %tmp113, align 2
	%tmp116 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 2, i32 1		
	store i16 0, i16* %tmp116, align 2
	%tmp127 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 1, i32 0		
	store i16 0, i16* %tmp127, align 2
	%tmp130 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 1, i32 1		
	store i16 0, i16* %tmp130, align 2
	%tmp141 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 0, i32 0		
	store i16 0, i16* %tmp141, align 8
	%tmp144 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 0, i32 1		
	store i16 0, i16* %tmp144, align 2
	%tmp148 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 7, i32 0		
	store i16 0, i16* %tmp148, align 2
	%tmp151 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 7, i32 1		
	store i16 0, i16* %tmp151, align 2
	%tmp162 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 6, i32 0		
	store i16 0, i16* %tmp162, align 2
	%tmp165 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 6, i32 1		
	store i16 0, i16* %tmp165, align 2
	%tmp176 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 5, i32 0		
	store i16 0, i16* %tmp176, align 2
	%tmp179 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 5, i32 1		
	store i16 0, i16* %tmp179, align 2
	%tmp190 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 4, i32 0		
	store i16 0, i16* %tmp190, align 2
	%tmp193 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 4, i32 1		
	store i16 0, i16* %tmp193, align 2
	%tmp204 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 3, i32 0		
	store i16 0, i16* %tmp204, align 2
	%tmp207 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 3, i32 1		
	store i16 0, i16* %tmp207, align 2
	%tmp218 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 2, i32 0		
	store i16 0, i16* %tmp218, align 2
	%tmp221 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 2, i32 1		
	store i16 0, i16* %tmp221, align 2
	%tmp232 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 1, i32 0		
	store i16 0, i16* %tmp232, align 2
	%tmp235 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 1, i32 1		
	store i16 0, i16* %tmp235, align 2
	%tmp246 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 0, i32 0		
	store i16 0, i16* %tmp246, align 8
	%tmp249 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 0, i32 1		
	store i16 0, i16* %tmp249, align 2
	%up_mvd252 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %up_mvd, i32 0, i32 0		
	%left_mvd253 = getelementptr [8 x %struct.MV], [8 x %struct.MV]* %left_mvd, i32 0, i32 0		
