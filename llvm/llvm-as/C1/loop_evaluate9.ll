...
@.str = internal constant [13 x i8] c"fc70a00.adb\00\00", align 1		
...
bb1.i:		
	%indvar.i = phi i32 [ 0, %entry ], [ %indvar.next.i, %bb2.i ]		
	%result.0.i = phi i16 [ 0, %entry ], [ %ins36.i, %bb2.i ]		
	%tmp38.i = trunc i16 %result.0.i to i8		
	%tmp = add i8 %tmp38.i, 96		
	%tmp1 = icmp ugt i8 %tmp, -56		
...
bb1.i.i:		
	%tmp41.i = lshr i16 %result.0.i, 8		
	%tmp42.i = trunc i16 %tmp41.i to i8		
	%tmp2 = add i8 %tmp42.i, 109		
	%tmp3 = icmp ugt i8 %tmp2, -56		
...
cc70a02__complex_integers__Oadd.153.exit.i:		
	%tmp4 = add i8 %tmp38.i, -4		
	%tmp5 = add i8 %tmp42.i, 9		
	%tmp25.i = zext i8 %tmp4 to i16		
	%tmp33.i = zext i8 %tmp5 to i16		
	%tmp34.i = shl i16 %tmp33.i, 8		
	%ins36.i = or i16 %tmp34.i, %tmp25.i		
	%tmp6 = icmp eq i32 %indvar.i, 6		
...
cc70a02__complex_multiplication.170.exit:		
	%tmp7 = icmp eq i8 %tmp4, -28		
	%tmp8 = icmp eq i8 %tmp5, 63		
	%or.cond = and i1 %tmp8, %tmp7		
