...
bcopy_internal.exit:		
	%conv135 = ptrtoint %struct.xyz* %header to i32		
	%shr136 = lshr i32 %conv135, 12		
	br label %for.body

for.body:		
	%ppnum.052 = phi i32 [ %inc, %for.body ], [ %shr136, %bcopy_internal.exit ]		
	%inc = add i32 %ppnum.052, 1		
	%cmp = icmp ugt i32 %inc, undef		
