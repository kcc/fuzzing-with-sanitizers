...
bb35:		
	%window.34 = phi i32 [ %tmp62, %cond_next60 ], [ 0, %bb63.outer ]		
	%tmp44 = getelementptr [4 x i32], [4 x i32]* null, i32 0, i32 0		
	%tmp46 = load i32, i32* %tmp44, align 4		
	br i1 false, label %cond_true50, label %cond_next60

cond_true50:		
	%tmp59 = getelementptr [4 x i32], [4 x i32]* null, i32 0, i32 0		
	store i32 0, i32* %tmp59, align 4
	br label %cond_next60

cond_next60:		
	%tmp62 = add i32 %window.34, 1		
	br i1 false, label %bb35, label %bb73

bb73:		
	%tmp76 = icmp slt i32 0, 0		
